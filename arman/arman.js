...
const songs = [
    ...
    {
        id:9,
        songName:`Pyar Maanga Hai - Armaan Malik<br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/9.jpg'
    },
    {
        id:10,
        songName:`Oye Hoye - Arman Malik<br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/10.jpg'
    },
    {
        id:11,
        songName:`Jab Se Mera Dil - Armaan Malik<br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/11.jpg'
        
    },
    {
        id:12,
        songName:`Sab Tera - Armaan Malik<br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/12.jpg'
       
    },
    {
        id:13,
        songName:`Barsaat - Armaan Malik <br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/13.jpg'
        
    },
    {
        id:14,
        songName:`Badnaamiya - Armaan Malik<br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/14.jpg'
      
    },
    {
        id:15,
        songName:`Tere Mere - Armaan Malik<br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/15.jpg'
      
    },
    {
        id:16,
        songName:`Pal Pal Dil Ke Paas - Armaan Malik<br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/16.jpg'
    
    },
    {
        id:17,
        songName:`Dil Mai Ho Tum - Armaan Malik<br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/17.jpg'
       
    },
    {
        id:18,
        songName:`Aaja Na Ferrari Mai - Armaan Malik<br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/18.jpg'
        
    },
    {
        id:19,
        songName:`Khaali Khaali Dil - Armaan Malik<br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/19.jpg'
        
    },
    {
        id:20,
        songName:`Kuch Too - Armaan Malik<br>
        <div class = "subtitle">Arman Malik</div>`,
        poster:'arman/img/20.jpg'
    },
    {
        id:21,
...
Array.from(document.getElementsByClassName('playList')).forEach((e)=>{
    e.addEventListener('click', (el)=>{
        ...
        music.src = `arman/music/${index}.mp3`;
        poster.src = `arman/img/${index}.jpg`;
        music.play()
        masterPlay.classList.remove('bi-play-fill') 
        masterPlay.classList.add('bi-pause-fill')

        download_music.href = `arman/music/${index}.mp3`
...
back.addEventListener('click', (el)=>{
    ...
    music.src = `arman/amusic/${index}.mp3`;
        poster.src = `arman/img/${index}.jpg`;
        music.play()
        masterPlay.classList.remove('bi-play-fill') 
        masterPlay.classList.add('bi-pause-fill')

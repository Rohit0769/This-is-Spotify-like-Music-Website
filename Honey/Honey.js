...
const songs = [
    ...
    {
        id:3,
        songName:`One Bottle Down - Honey Singh<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/3.jpg'
    },
    {
        id:4,
        songName:`Kalastar - Honey Singh<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/4.jpg'
    },
    {
        id:5,
    ...
    {
        id:6,
        songName:`Love Dose - Honey Singh<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/6.jpg'
    },
    {
        id:7,
        songName:`Dope Shope - Honey Singh<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/7.jpg'
    },
    {
        id:8,
        songName:`Desi Kalakar - Honey Singh<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/8.jpg'
    },
    {
        id:9,
        songName:`Brown Rang - Honey Singh<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/9.jpg'
    },
    {
        id:10,
        songName:`Chote Chote Peg Maar - Sonu Ke Titu Ki Sweety<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/10.jpg'
    },
    {
        id:11,
        songName:`Chaar Bottle Vodka - Honey Singh<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/11.jpg'
    },
    {
        id:12,
        songName:`High Heels - Honey Singh<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/12.jpg'
    },
    {
        id:13,
        songName:`Party On Mind - Race 2<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/13.jpg'
    },
    {
        id:14,
        songName:`Aata Maaji Satak li - Singham Returns<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/14.jpg'
    },
    {
        id:15,
        songName:`Dil Chori Sadda Hogaya - Sonu Ke titu ki Sweety<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster:'Honey/img/15.jpg'
    },
...
Array.from(document.getElementsByClassName('playList')).forEach((e)=>{
    e.addEventListener('click', (el)=>{
        ...
        music.src = `Honey/music/${index}.mp3`;
        poster.src = `Honey/img/${index}.jpg`;
        music.play()
        masterPlay.classList.remove('bi-play-fill') 
        masterPlay.classList.add('bi-pause-fill')

        download_music.href = `Honey/music/${index}.mp3`
...
back.addEventListener('click', (el)=>{
    ...
    music.src = `Honey/amusic/${index}.mp3`;
        poster.src = `Honey/img/${index}.jpg`;
        music.play()
        masterPlay.classList.remove('bi-play-fill') 
        masterPlay.classList.add('bi-pause-fill')

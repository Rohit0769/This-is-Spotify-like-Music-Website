...
const songs = [
    {
        id:1,
        songName:`Vasste - Dhavni Bhanushali<br>
        <div class = "subtitle">Dhavni Bhanushali</div>`,
        poster:'Dhavni/img/1.jpg'
    },
    {
        id:3,
    ...
    {
        id:3,
        songName:`Dhuniya - Lukka Chuppi<br>
        <div class = "subtitle">Dhavni Bhanushali</div>`,
        poster:'Dhavni/img/3.jpg'
    },
    {
        id:4,
        songName:`Humsafar - Acoustic<br>
        <div class = "subtitle">Dhavni Bhanushali</div>`,
        poster:'Dhavni/img/4.jpg'
    },
    {
        id:5,
    ...
    {
        id:6,
        songName:`Nayan - Dhavni Bhanushali<br>
        <div class = "subtitle">Dhavni Bhanushali, Jubin Nautyal</div>`,
        poster:'Dhavni/img/6.jpg'
    },
    {
        id:7,
        songName:`Mai Teri Hu - Album<br>
        <div class = "subtitle">Dhavni Bhanushali</div>`,
        poster:'Dhavni/img/7.jpg'
    },
    {
        id:8,
        songName:`Le ja - Dhavni Bhanushali<br>
        <div class = "subtitle">Dhavni Bhanushali</div>`,
        poster:'Dhavni/img/8.jpg'
    },
    {
        id:9,
        songName:`Baby girl - Dhavni Bhanushali<br>
        <div class = "subtitle">Dhavni Bhanushali, Guru Randhava</div>`,
        poster:'Dhavni/img/9.jpg'
    },
    {
        id:10,
        songName:`Kinna Sonna - Marjaanva<br>
        <div class = "subtitle">Dhavni Bhanushali, Jubin Nautiyal</div>`,
        poster:'Dhavni/img/10.jpg'
    },
    {
        id:11,
        songName:`Isaare Tere Kangree Ni<br>
        <div class = "subtitle">Dhavni Bhanushali</div>`,
        poster:'Dhavni/img/11.jpg'
    },
    {
        id:12,
        songName:`Naina Milake - Dhavni Bhanushali<br>
        <div class = "subtitle">Dhavni Bhanushali</div>`,
        poster:'Dhavni/img/12.jpg'
    },
    {
        id:13,
        songName:`Veere - Veere di weeding<br>
        <div class = "subtitle">Dhavni Bhanushali</div>`,
        poster:'Dhavni/img/13.jpg'
    },
    {
        id:14,
        songName:`Dhynamite- Dhavni Bhanushali<br>
        <div class = "subtitle">Dhavni Bhanushali</div>`,
        poster:'Dhavni/img/14.jpg'
    },
    {
        id:15,
        songName:`Mukhda Vekh Ke - De De Pyar De<br>
        <div class = "subtitle">Dhavni Bhanushali</div>`,
        poster:'Dhavni/img/15.jpg'
...
Array.from(document.getElementsByClassName('playList')).forEach((e)=>{
    e.addEventListener('click', (el)=>{
        ...
        music.src = `Dhavni/music/${index}.mp3`;
        poster.src = `Dhavni/img/${index}.jpg`;
        music.play()
        masterPlay.classList.remove('bi-play-fill') 
        masterPlay.classList.add('bi-pause-fill')

        download_music.href = `Dhavni/music/${index}.mp3`
